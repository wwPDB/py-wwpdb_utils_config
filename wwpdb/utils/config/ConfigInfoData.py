...
class ConfigInfoData(object):
    ...
    _contentTypeInfoBaseD = {
        ...
        "em-focused-refinement-volume-mask": (["map", "ccp4", "mrc2000", "bcif"], "em-focused-refinement-volume-mask"),
        ...
        "em-raw-volume-wfcfg": (["json"], "em-raw-volume-wfcfg"),
        "em-fsc-half-volume-mask-wfcfg": (["json"], "em-fsc-half-volume-mask-wfcfg"),
        "em-fsc-map-model-volume-mask-wfcfg": (["json"], "em-fsc-map-model-volume-mask-wfcfg"),
        "em-alignment-volume-mask-wfcfg": (["json"], "em-alignment-volume-mask-wfcfg"),
        "em-focused-refinement-volume-mask-wfcfg": (["json"], "em-focused-refinement-volume-mask-wfcfg"),
        "em-3d-classification-additional-volume-wfcfg": (["json"], "em-3d-classification-additional-volume-wfcfg"),
        "em-focus-refinement-additional-volume-wfcfg": (["json"], "em-focus-refinement-additional-volume-wfcfg"),
        "em-segmentation-volume-wfcfg": (["json"], "em-segmentation-volume-wfcfg"),
        ...
        "res-est-fsc": (["xml"], "fsc-xml"),
        "res-est-fsc-report": (["txt"], "fsc-report"),
        "map-model-fsc": (["xml"], "fsc-xml"),
        "map-model-fsc-report": (["txt"], "fsc-report"),
    ...
    _siteDataSetIdAssignmentD = {
        ...
        "WWPDB_DEPLOY_PRODUCTION_BACKUP_RU": (1001310119, 1001350000),
